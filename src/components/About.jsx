...
export default function About() {
  return (
    <section className="bg-white text-black py-20 px-6 text-center font-zabal" id="about">
      <h2 className="text-4xl font-black italic uppercase mb-6 text-yellow-500">
        ¿Quiénes somos?
      </h2>
  ...
  Ubicados en Tijuana, somos tu refaccionaria de confianza.
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 text-left">
        <div className="bg-gray-100 p-6 rounded-xl shadow-sm">
          <h3 className="text-2xl font-bold italic mb-3 text-yellow-600">Misión</h3>
        ...
        <div className="bg-gray-100 p-6 rounded-xl shadow-sm">
          <h3 className="text-2xl font-bold italic mb-3 text-yellow-600">Visión</h3>
          <p className="text-base text-gray-700 leading-relaxed">
